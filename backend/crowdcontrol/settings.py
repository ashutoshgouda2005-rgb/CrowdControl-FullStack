"""
Django settings for crowdcontrol project.
"""
...
ALLOWED_HOSTS_ENV = os.environ.get('ALLOWED_HOSTS', 'localhost,127.0.0.1,0.0.0.0,.railway.app,.herokuapp.com,.onrender.com')
...
ROOT_URLCONF = 'crowdcontrol.urls'
...
WSGI_APPLICATION = 'crowdcontrol.wsgi.application'
...
# Channels configuration for WebSocket (in-memory for development)
CHANNEL_LAYERS = {
    'default': {
...
HAAR_CASCADE_PATH = os.environ.get('HAAR_CASCADE_PATH', os.path.join(BASE_DIR.parent, 'haarcascade_frontalface_default.xml'))
